    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TurfAmenities", x => x.Id);
                    table.ForeignKey(
                        name: "FK_TurfAmenities_Turfs_TurfId",
                        column: x => x.TurfId,
                        principalTable: "Turfs",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_MatchParticipants_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Bookings_TurfId_BookingDate_StartTime",
                table: "Bookings",
                columns: new[] { "TurfId", "BookingDate", "StartTime" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Matches_TurfId_MatchDate",
                table: "Matches",
                columns: new[] { "TurfId", "MatchDate" });
